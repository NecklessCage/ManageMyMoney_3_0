...
public class ImageTextButton extends LinearLayout {
    ...
    public ImageTextButton(Context context, AttributeSet attrs) {
        ...
        float width = attr.getDimension(R.styleable.ImageTextButton_separation, 20);
        ...
        //int text_size = attr.getDimensionPixelSize(R.styleable.ImageTextButton_textSize, 10);
        ...
        separator.setLayoutParams(new LayoutParams((int) width,
